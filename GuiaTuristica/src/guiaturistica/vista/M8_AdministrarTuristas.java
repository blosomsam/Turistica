...
public class M8_AdministrarTuristas extends javax.swing.JInternalFrame {
   private Usuario per;
    ModeloGenericoTabla mgt;
    
    public M8_AdministrarTuristas() {
        initComponents();
        this.mostarRestaurantes();
    }
    
    public void mostarRestaurantes() {
        TuristaJpaControl turjpa = new TuristaJpaControl(JPAUtil.getEntityManagerFactory());
        List turistas = null;
        
       turistas = turjpa.buscarTuristaEntidad();
       Object fb = null;
       
        Vector vturistas = new Vector();
        Object gb = null;
        
        String [] columnas = new String[]{"Nombres","Lugar de origen","Telefónos"};
        String [] campos = new String[] {"nombres","lugarDeOrigen","telefono"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, turistas);
        this.tablaTuristas.setModel(this.mgt);
    }
    ...
    private void initComponents() {
        ...
        tablaTuristas = new javax.swing.JTable();
        ...
        tablaTuristas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablaTuristas);
    ...
    private javax.swing.JTable tablaTuristas;
