 ...
 * @author sandrojc
 */
public class M7_AdministraCuentas extends javax.swing.JInternalFrame {
private Usuario per;
    ModeloGenericoTabla mgt;
    public M7_AdministraCuentas() {
        initComponents();
        this.mostarCuentas();
    }

    public void mostarCuentas() {
        CuentaJpaControl cujpa = new CuentaJpaControl(JPAUtil.getEntityManagerFactory());
        List cuentas = null;
        
       cuentas = cujpa.buscarCuentaEntidad();
       Object fb = null;
       
        Vector vCuenta = new Vector();
        Object gb = null;
        
        String [] columnas = new String[]{"Id cuenta","Nombre Usuario","Clave usuario"};
        String [] campos = new String[] {"id_cuenta","nombreUsuario","claveUsuario"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, cuentas);
        this.tablaCuentas.setModel(this.mgt);
    }
