...
public class M3_AdministrarTiendas extends javax.swing.JInternalFrame {
    private Usuario per;
    ModeloGenericoTabla mgt;

    public M3_AdministrarTiendas() {
        initComponents();
        this.mostrarTiendas();
    }
    
    public void mostrarTiendas () {
       TiendaJpaControl tiejpa = new TiendaJpaControl(JPAUtil.getEntityManagerFactory());
        List tiendas = null;
        
        Vector vTienda = new Vector();
        Object fb = null;
        
        tiendas = tiejpa.buscarTiendaEntidad();
        String [] columnas = new String[] {"Nombre","Tipo","Dirección"};
        String [] campos = new String[] {"nombreTienda","tipoTienda","direccionTienda"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, tiendas);
        this.tablaTiendas.setModel(mgt);
    }
