...
public class M5_AdministrarTransporte extends javax.swing.JInternalFrame {
private Usuario per;
    ModeloGenericoTabla mgt;
    public M5_AdministrarTransporte() {
        initComponents();
        this.mostarTrasporte();
    }

   public void mostarTrasporte() {
        TransporteJpaControl trajpa = new TransporteJpaControl(JPAUtil.getEntityManagerFactory());
        List transportes = null;
        
       transportes = trajpa.buscarTransporteEntidad();
       Object fb = null;
       
        Vector Vtransportes = new Vector();
        Object gb = null;
        
        String [] columnas = new String[]{"Cooperativa","Tipo tranporte","Horarios"};
        String [] campos = new String[] {"nombreTransporte","tipo_transporte","horarioTransporte"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, transportes);
        this.tablatTransporte.setModel(this.mgt);
    }
    ...
    private void initComponents() {
        ...
        tablatTransporte = new javax.swing.JTable();
        ...
        tablatTransporte.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablatTransporte);
    ...
    private javax.swing.JTable tablatTransporte;
