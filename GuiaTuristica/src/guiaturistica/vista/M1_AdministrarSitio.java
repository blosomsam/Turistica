...
public class M1_AdministrarSitio extends javax.swing.JInternalFrame {
    private Usuario per;
    ModeloGenericoTabla mgt; 
    
    public M1_AdministrarSitio() {
        initComponents();
        this.mostrarSitios();// para cargar el momento en el que se incia
    }
private void mostrarSitios() {
        SitioJpaControl sjc = new SitioJpaControl(JPAUtil.getEntityManagerFactory());
        List sitios = null;
        
        Vector sitiosC = new Vector();
        Object fb = null;
        sitios = sjc.buscarSitioEntidad();
        String[] columnas = new String[]{"Nombre","Decripción","Servicios"};
        String[] campos = new String[]{"nombreSitio","descripcionSitio","serviciosSitio"};
        
        this.mgt = new  ModeloGenericoTabla(columnas, campos, sitios);
        this.tablaSitios.setModel(this.mgt);
    ...
    private void initComponents() {
        ...
        tablaSitios = new javax.swing.JTable();
        ...
        tablaSitios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablaSitios);
        ...
        jLabel11.setText("SITIOS TURISTICOS ");
    ...
    private javax.swing.JTable tablaSitios;
