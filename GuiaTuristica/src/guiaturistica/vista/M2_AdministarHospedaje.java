...
public class M2_AdministarHospedaje extends javax.swing.JInternalFrame {
    private Usuario per;
    ModeloGenericoTabla mgt;
    
    public M2_AdministarHospedaje() {
        initComponents();
        this.mostrarHospedajes();
        
    }
    public  void mostrarHospedajes(){
        HospedajeJpaControl hosjpa = new HospedajeJpaControl(JPAUtil.getEntityManagerFactory());
        List hospedajes = null;
        
        Vector vSitios = new Vector();
        Object fb = null;
        hospedajes = hosjpa.buscarHospedajeEntidad();
       
        String [] columnas = new String[]{"Nombre","Tipo","Servicios"};
        String [] campos = new String[]{"nombreHospedaje","tipoHospedaje","serviciosHospedaje"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, hospedajes);
        this.tablaHospedajes.setModel(this.mgt);
    }
    ...
    private void initComponents() {
        ...
        tablaHospedajes = new javax.swing.JTable();
        ...
        tablaHospedajes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablaHospedajes);
    ...
    private javax.swing.JTable tablaHospedajes;
