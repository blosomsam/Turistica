...
public class M4_AdministrarRestaurantes extends javax.swing.JInternalFrame {
    private Usuario per;
    ModeloGenericoTabla mgt;
    

    public M4_AdministrarRestaurantes() {
        initComponents();
        this.mostarRestaurantes();
    }
    
    public void mostarRestaurantes() {
        RestaurantJpaControl resjpa = new RestaurantJpaControl(JPAUtil.getEntityManagerFactory());
        List restaurantes = null;
        
       restaurantes = resjpa.buscarRestaurantEntidad();
       Object fb = null;
       
        Vector vRestaurantes = new Vector();
        Object gb = null;
        
        String [] columnas = new String[]{"Nombre","Direccion","valor promedio"};
        String [] campos = new String[] {"nombreRestaurant","direccionRestaurant","valorPromedioPlato"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, restaurantes);
        this.tablaRestaurantes.setModel(this.mgt);
    }
