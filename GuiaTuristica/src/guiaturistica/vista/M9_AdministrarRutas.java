...
public class M9_AdministrarRutas extends javax.swing.JInternalFrame {
private Usuario per;
    ModeloGenericoTabla mgt;
    public M9_AdministrarRutas() {
        initComponents();
        this.mostarRutas();
    }
    
    public void mostarRutas() {
        RutaJpaControl rutjpa = new RutaJpaControl(JPAUtil.getEntityManagerFactory());
        List rutas = null;
        
       rutas = rutjpa.buscarRutaEntidad();
       Object fb = null;
       
        Vector vRutas = new Vector();
        Object gb = null;
        
        String [] columnas = new String[]{"Nombre","Origen","Tiempo"};
        String [] campos = new String[] {"nombreRuta","origen","tiempo"};
        
        this.mgt = new ModeloGenericoTabla(columnas, campos, rutas);
        this.tablaRutas.setModel(this.mgt);
    }
